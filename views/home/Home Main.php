...
<body>
  ...
  <div class="page">
    ...
    <section class="section main-section parallax-scene-js" style="background:url('<?php echo BASE_URL; ?>assets/images/Images/MainBG.jpg') no-repeat center center; background-size:cover;margin-top: 70px; min-height: 93vh; padding:0;">
      <div class="row justify-content-center h-100 w-100">
        <div class="col-xl-8 col-12 my-auto">
          <h2 class="text-white text-left p-0 mb-lg-2 mb-1 wow fadeInLeft">Find the right job for you.</h2>
          <h4 class="text-white text-left p-0 mb-lg-2 mb-1 wow fadeInLeft">We're here to help you find the most suitable
            job for you.</h4>
        ...
        <div class="col-12 text-center offset-top-75" data-wow-delay=".2s"><a class="button-way-point d-inline-block text-center d-inline-flex flex-column justify-content-center" href="#" data-custom-scroll-to="TopPartners"><span class="fa-chevron-down"></span></a></div>
      </div>
